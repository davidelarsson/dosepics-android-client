...
/**
 * Activity that displays the user's images
 *
 */
public class ImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set progress bar telling user we're waiting for number of images
        getListOfImages();
    }
    ...
    // Get number of images owned by user
    ...
    /**
     * Called when number of images received
     */
    ...
    public class ImageCollectionPagerAdapter extends FragmentStatePagerAdapter {
        ...
        // FIXME: Will I need this anymore?
        @Override
    ...
    public static class ImageFragment extends Fragment {
        ...
        private enum Mode { NONE, THUMB, IMAGE, IMAGE_WITH_INFO };
        private Mode mode;
        ...
        private void thumbReceived()
        {
            ...
            // In 5000 ms, get the final image
        ...
        // Perform the actual loading of a new image
        private void doLoadRealImage()
        {
            // Are we already loading the real image?
            // This happens if the automatic load is triggered after the user has already
            // clicked the image
        ...
        private void updateFragment() {
            ...
            // Always use full screen FIXME: Move this part
            ...
            // If we haven't received the thumbnail yet, just add a progress bar
            if (mode == Mode.NONE) {
            ...
            // Framelayout to put image and bottom bar into
            ...
            // Image view to be put into frameLayout
            ...
            iv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    toggleFullScreen();
                    // Also, if we don't have the real image yet, start loading it immediately
                    if (mode == Mode.THUMB)
                        doLoadRealImage();
                }
            });
            ...
            if (((ImageActivity) getActivity()).fullscreen) {
                ...
                try {
                    ...
                    // But disable it again in 5000 ms
        ...
        class ActionBarHider implements Runnable {
            ...
            public void run() {
                ...
                if (!((ImageActivity) getActivity()).fullscreen && !isCancelled)
                    toggleFullScreen();
        ...
        private void toggleFullScreen() {
            if (((ImageActivity) getActivity()).fullscreen)
                ((ImageActivity) getActivity()).fullscreen = false;
            else
        ...
        public void onDestroy() {
            // Inform AsyncTask that its work was pointless and its result shall not be used
            if(getImage != null)
                getImage.cancel(true);
            if(getThumb != null)
                getThumb.cancel(true);
            super.onDestroy();
        }


        /**********************************************************
         * AsyncTask that gets thumbnail from the REST API
         **********************************************************/
